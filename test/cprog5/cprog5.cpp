...
class Sf_cprog5 : public SouffleProgram {
private:
...
wrapper_rel_4_loop(*rel_4_loop,symTable,"loop",std::array<const char *,4>{{"i:number","i:number","i:number","i:number"}},std::array<const char *,4>{{"i","x","y","z"}}){
...
/* BEGIN STRATUM 3 */
[&]() {
SignalHandler::instance()->setMsg(R"_(loop(0,0,0,0).
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [17:1-17:18])_");
rel_4_loop->insert(RamDomain(0),RamDomain(0),RamDomain(0),RamDomain(0));
rel_5_delta_loop->insertAll(*rel_4_loop);
iter = 0;
for(;;) {
SignalHandler::instance()->setMsg(R"_(loop(1,h,y,z) :- 
   loop(0,_,y,z),
   high(h).
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [19:1-19:46])_");
if(!(rel_1_high->empty()) && !(rel_5_delta_loop->empty())) {
[&](){
...
for(const auto& env1 : *rel_1_high) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(1),env1[0],env0[2],env0[3]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt)))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(1)),static_cast<RamDomain>(env1[0]),static_cast<RamDomain>(env0[2]),static_cast<RamDomain>(env0[3])}};
...
();}
SignalHandler::instance()->setMsg(R"_(loop(2,x,y,m) :- 
   loop(1,x,y,_),
   med(m).
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [20:1-20:45])_");
if(!(rel_3_med->empty()) && !(rel_5_delta_loop->empty())) {
[&](){
...
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(2),env0[1],env0[2],env1[0]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt)))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(2)),static_cast<RamDomain>(env0[1]),static_cast<RamDomain>(env0[2]),static_cast<RamDomain>(env1[0])}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
...
();}
SignalHandler::instance()->setMsg(R"_(loop(3,x,l,z) :- 
   loop(0,_,_,z),
   loop(1,x,_,_),
   low(l).
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [21:1-21:63])_");
if(!(rel_2_low->empty()) && !(rel_4_loop->empty()) && !(rel_5_delta_loop->empty())) {
[&](){
...
if( !(rel_5_delta_loop->contains(Tuple<RamDomain,4>{{RamDomain(1),env1[1],env1[2],env1[3]}},READ_OP_CONTEXT(rel_5_delta_loop_op_ctxt)))) {
for(const auto& env2 : *rel_2_low) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(3),env1[1],env2[0],env0[3]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt)))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(3)),static_cast<RamDomain>(env1[1]),static_cast<RamDomain>(env2[0]),static_cast<RamDomain>(env0[3])}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
...
SignalHandler::instance()->setMsg(R"_(loop(3,x,l,z) :- 
   ...
   low(l).
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [21:1-21:63])_");
if(!(rel_2_low->empty()) && !(rel_5_delta_loop->empty()) && !(rel_4_loop->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_2_low_op_ctxt,rel_2_low->createContext());
CREATE_OP_CONTEXT(rel_4_loop_op_ctxt,rel_4_loop->createContext());
CREATE_OP_CONTEXT(rel_5_delta_loop_op_ctxt,rel_5_delta_loop->createContext());
...
();}
SignalHandler::instance()->setMsg(R"_(loop(7,x,y,z) :- 
   loop(3,x,y,z),
   x <= y.
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [23:1-23:46])_");
if(!(rel_5_delta_loop->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_4_loop_op_ctxt,rel_4_loop->createContext());
CREATE_OP_CONTEXT(rel_5_delta_loop_op_ctxt,rel_5_delta_loop->createContext());
CREATE_OP_CONTEXT(rel_6_new_loop_op_ctxt,rel_6_new_loop->createContext());
const Tuple<RamDomain,4> key{{RamDomain(3),0,0,0}};
auto range = rel_5_delta_loop->equalRange_1(key,READ_OP_CONTEXT(rel_5_delta_loop_op_ctxt));
for(const auto& env0 : range) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(7),env0[1],env0[2],env0[3]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt))) && ((env0[1]) <= (env0[2]))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(7)),static_cast<RamDomain>(env0[1]),static_cast<RamDomain>(env0[2]),static_cast<RamDomain>(env0[3])}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
();}
SignalHandler::instance()->setMsg(R"_(loop(4,x,0,z) :- 
   loop(3,x,y,z),
   x > y.
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [25:1-25:45])_");
if(!(rel_5_delta_loop->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_4_loop_op_ctxt,rel_4_loop->createContext());
CREATE_OP_CONTEXT(rel_5_delta_loop_op_ctxt,rel_5_delta_loop->createContext());
...
auto range = rel_5_delta_loop->equalRange_1(key,READ_OP_CONTEXT(rel_5_delta_loop_op_ctxt));
for(const auto& env0 : range) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(4),env0[1],RamDomain(0),env0[3]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt))) && ((env0[1]) > (env0[2]))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(4)),static_cast<RamDomain>(env0[1]),static_cast<RamDomain>(RamDomain(0)),static_cast<RamDomain>(env0[3])}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
();}
SignalHandler::instance()->setMsg(R"_(loop(4,x,(y+1),z) :- 
   loop(4,x,y,z),
   z > y.
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [27:1-27:47])_");
if(!(rel_5_delta_loop->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_4_loop_op_ctxt,rel_4_loop->createContext());
CREATE_OP_CONTEXT(rel_5_delta_loop_op_ctxt,rel_5_delta_loop->createContext());
CREATE_OP_CONTEXT(rel_6_new_loop_op_ctxt,rel_6_new_loop->createContext());
const Tuple<RamDomain,4> key{{RamDomain(4),0,0,0}};
auto range = rel_5_delta_loop->equalRange_1(key,READ_OP_CONTEXT(rel_5_delta_loop_op_ctxt));
for(const auto& env0 : range) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(4),env0[1],(env0[2]) + (RamDomain(1)),env0[3]}},READ_OP_CONTEXT(rel_4_loop_op_ctxt))) && ((env0[3]) > (env0[2]))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(4)),static_cast<RamDomain>(env0[1]),static_cast<RamDomain>((env0[2]) + (RamDomain(1))),static_cast<RamDomain>(env0[3])}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
();}
SignalHandler::instance()->setMsg(R"_(loop(3,x,y,(z+1)) :- 
   loop(4,x,y,z),
   z <= y.
in file /Users/patrickyh/Documents/Academics/20wi/sdl/test/cprog5/cprog5.dl [29:1-29:48])_");
if(!(rel_5_delta_loop->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_4_loop_op_ctxt,rel_4_loop->createContext());
CREATE_OP_CONTEXT(rel_5_delta_loop_op_ctxt,rel_5_delta_loop->createContext());
...
auto range = rel_5_delta_loop->equalRange_1(key,READ_OP_CONTEXT(rel_5_delta_loop_op_ctxt));
for(const auto& env0 : range) {
if( !(rel_4_loop->contains(Tuple<RamDomain,4>{{RamDomain(3),env0[1],env0[2],(env0[3]) + (RamDomain(1))}},READ_OP_CONTEXT(rel_4_loop_op_ctxt))) && ((env0[3]) <= (env0[2]))) {
Tuple<RamDomain,4> tuple{{static_cast<RamDomain>(RamDomain(3)),static_cast<RamDomain>(env0[1]),static_cast<RamDomain>(env0[2]),static_cast<RamDomain>((env0[3]) + (RamDomain(1)))}};
rel_6_new_loop->insert(tuple,READ_OP_CONTEXT(rel_6_new_loop_op_ctxt));
}
}
}
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","i\tx\ty\tz"},{"filename","./loop.ans"},{"name","loop"}});
...
SouffleProgram *newInstance_cprog5(){return new Sf_cprog5;}
SymbolTable *getST_cprog5(SouffleProgram *p){return &reinterpret_cast<Sf_cprog5*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_cprog5: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_cprog5();
};
public:
factory_Sf_cprog5() : ProgramFactory("cprog5"){}
};
static factory_Sf_cprog5 __factory_Sf_cprog5_instance;
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(cprog5.dl)",
R"(.)",
R"(.)",
false,
R"()",
